...
#define JNI_CROP_FN(A) Java_org_ebookdroid_common_bitmaps_ ## A
...
jobject
JNI_CROP_FN(ByteBufferBitmap_create)(JNIEnv *env, jclass classObject, jint size) {
...
void
JNI_CROP_FN(ByteBufferBitmap_free)(JNIEnv *env, jclass classObject, jobject obj) {
    if (!obj) {
        return;
    }
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeInvert)(JNIEnv *env, jclass classObject,
                                           jobject srcBuffer,
 ...
 */
void
JNI_CROP_FN(ByteBufferBitmap_nativeTint)(JNIEnv *env, jclass classObject,
                                         jobject srcBuffer,
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeFillAlpha)(JNIEnv *env, jclass classObject,
                                              jobject srcBuffer,
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeEraseColor)(JNIEnv *env, jclass classObject,
                                               jobject srcBuffer,
                                               jint width, jint height, jint c) {
    int i;
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeContrast)(JNIEnv *env, jclass classObject,
                                             jobject srcBuffer,
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeGamma)(JNIEnv *env, jclass classObject,
                                          jobject srcBuffer,
...
jint
JNI_CROP_FN(ByteBufferBitmap_nativeAvgLum)(JNIEnv *env, jclass classObject,
                                           jobject srcBuffer,
                                           jint width, jint height) {
    int i, a;
    int midBright = 0;
    ...
    for (i = 0; i < width * height * 4; i += 4) {
        midBright += (MIN(src[i + 2], MIN(src[i + 1], src[i])) +
                      MAX(src[i + 2], MAX(src[i + 1], src[i]))) / 2;
    }
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeExposure)(JNIEnv *env, jclass classObject,
                                             jobject srcBuffer,
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeAutoLevels)(JNIEnv *env, jclass classObject,
                                               jobject srcBuffer,
                                               jint width, jint height) {
    int i;
    int histoR[256];
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeAutoLevels2)(JNIEnv *env, jclass classObject,
...
void
JNI_CROP_FN(ByteBufferBitmap_nativeFillRect)(JNIEnv *env, jclass classObject,
                                             jobject srcBuffer,
