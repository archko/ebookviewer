...
public class BookSettings implements CurrentPageListener {
    ...
    BookSettings(final JSONObject object) throws JSONException {
        this.persistent = true;
        this.lastChanged = 0;
        this.fileName = object.optString("fileName");
        this.lastUpdated = object.optLong("lastUpdated");

        this.firstPageOffset = object.optInt("firstPageOffset", 1);
        this.currentPage = new PageIndex(object.optJSONObject("currentPage"));
        this.zoom = object.optInt("zoom");
        this.splitPages = object.optBoolean("splitPages");
        ...
        this.cropPages = object.optBoolean("cropPages");
        this.offsetX = (float) object.optDouble("offsetX");
        this.offsetY = (float) object.optDouble("offsetY");
        this.nightMode = object.optBoolean("nightMode");
        ...
        this.contrast = object.optInt("contrast");
        this.gamma = object.optInt("gamma", AppPreferences.GAMMA.defValue);
        this.exposure = object.optInt("exposure");
        this.autoLevels = object.optBoolean("autoLevels");
