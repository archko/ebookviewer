...
public class DocumentModel extends ListenerProxy {
    ...
    private DocumentInfo retrieveDocumentInfo(final BookSettings bs, final IProgressIndicator task) {
