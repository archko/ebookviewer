...
public class OPDSAdapter extends BaseExpandableListAdapter {
    ...
    public OPDSAdapter(final Context context, final IActionController<?> actions) {
        ...
        this.actions = new ActionController<>(actions, this);
        this.client = new OPDSClient(new ExtentedEntryBuilder());

        this.rootFeeds = new ArrayList<>();
    ...
    public void showAuthDlg(final Object info) {
        ...
        final EditText editUsername = view.findViewById(R.id.opds_auth_editUsername);
        final EditText editPassword = view.findViewById(R.id.opds_auth_editPassword);
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        public void init(final View convertView) {
            ...
            textView = convertView.findViewById(R.id.opdsItemText);
            imageView = convertView.findViewById(R.id.opdsItemIcon);
            info = convertView.findViewById(R.id.opdsDescription);
        }
    }
