...
public class HyphenationUtils {
    ...
    private static final SparseArray<Symbol> classes = new SparseArray<>();
    ...
    public static int hyphenateWord(final char[] str, final int begin, final int len, final int[] outStart,
                                    final int[] outLength) {
        if (str == null) {
            return 0;
        }
    ...
    private static final class HyphenRuleNode {
        ...
        final LinkedList<HyphenRule> rulez = new LinkedList<>();
